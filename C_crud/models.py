...
class Subjects(models.Model):
    ...
    duration_of_course = models.CharField(max_length=150,null=False,blank=False)
    education_filial = models.ForeignKey(Education_filial,on_delete=models.CASCADE, null=True,blank=False)
    teacher_id = models.ForeignKey(CustumUsers,on_delete=models.CASCADE,null=True,blank=False)
...
class Education_students(models.Model): 
    ...
    education_main = models.ForeignKey(Education_main,on_delete=models.CASCADE, null=False,blank=False)
    education_filial = models.ForeignKey(Education_filial,on_delete=models.CASCADE, null=False,blank=False)
    group_id = models.ManyToManyField (Education_group,null=False,blank=False)
